...
print(HEAT_MAX_REAL, HEAT_MAX_APPRO)
print(HEAT_MIN_REAL,HEAT_MIN_APPRO )
...
print(df_features_train.max())
print(df_features_train.min())


print(df_features_test.max())
print(df_features_test.min())
